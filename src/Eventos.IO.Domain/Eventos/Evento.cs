...
namespace Eventos.IO.Domain.Eventos
{
    public class Evento : Entity<Evento>
    {
        ...
        /// <param name="descricaoCurta"></param>
        /// <param name="descricaoLonga"></param>
        /// <param name="dataInicio"></param>
        /// <param name="dataFim"></param>
        /// <param name="gratuito"></param>
        ...
        private void ValidarNome()
        {
            RuleFor(c => c.Nome)
                ...
                .Length(2, 15).WithMessage("O nome do evento precisa ter entre 2 e 150 caracteres.");
        }
        ...
        private void ValidarData()
        {
            RuleFor(c => c.DataInicio)
                ...
                .WithMessage("A data de incio deve ser maior que a data final do evento.");
